    ...
    <main class="p-4 w-full">
        ...
        <div class="overflow-x-auto bg-white shadow-md rounded-lg p-6">
            <table class="min-w-full table-auto border-collapse">
                <thead>
                    <tr>
                        <th class="px-4 py-2 text-left font-semibold text-gray-700">Driver</th>
                        <th class="px-4 py-2 text-left font-semibold text-gray-700">Issue</th>
                ...
                <tbody>
                    @foreach ($reports as $report)
                        <tr class="hover:bg-gray-100">
                            <td class="px-4 py-2 border-t border-gray-200">{{ $report->driver->name }}</td>
                            <td class="px-4 py-2 border-t border-gray-200">{{ $report->description }}</td>
                            <td class="px-4 py-2 border-t border-gray-200">{{ $report->reported_at }}</td>
                        </tr>
                    @endforeach
                </tbody>
            </table>
