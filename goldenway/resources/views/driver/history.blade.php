...
<body>
    ...
    <div class="body">
        ...
        <section class="section-1 bg-gray-100 py-8 px-4 mb-52">
    <h1 class="text-2xl font-bold text-gray-800 mb-6 text-center">Historys</h1>
            ...
            <tbody>
                @forelse ($schedules as $schedule)
                    <tr class="hover:bg-gray-100">
                        ...
                        </td>  <td class="px-6 py-4 border-b">
                            <span class="font-medium text-gray-800">
