        ...
        <style>
            * {
            ...
            .header {
                ...
                align-items: center;
                padding: 20px 30px;
                background: goldenrod; /* orange-400 */
                color: #fff;
            ...
            .side-bar ul li:hover {
                background-color: goldenrod; /* orange-400 */
                color: white;
            }
            ...
            .btn-submit:hover {
                background-color: #1E66A4; /* dark orange */
            }
...
.btn-danger:hover {
    ...
    <body>
        ...
        <main class="p-4 w-100 section-1 mb-60">
            <h1>Trips</h1>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td data-label="Route">{{ $trip->route->origin }} - {{ $trip->route->destination }}</td>
            <td data-label="Date">{{ $trip->date}}</td>
            <td data-label="Departure Time">{{ $trip->departure_time }}</td>
            <td data-label="Arrival Time">{{ $trip->arrival_time }}</td>
            <td data-label="Price">{{ $trip->price }}</td>
            <td data-label="Capacity">{{ $trip->capacity }}</td>
            <td data-label="Actions">
    <a href="{{ route('trips.edit', ['trip' => $trip->id, 'route' => $trip->route->id]) }}" class="btn btn-primary btn-sm">Edit</a>
