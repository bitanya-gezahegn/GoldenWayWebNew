                ...
                <main class="content-section">
                    ...
                    <form action="{{ url('routes.edit_confirm', $routes->id) }}" method="POST" class="form-container">
                        ...
                        <div class="form-group">
                            ...
                            <label for="bus_stops" class="form-label">bus_stops :</label>
                            <input type="text" id="bus_stops" name="bus_stops" class="form-control" value="{{ $routes->bus_stops }}" required>
                        </div> <div class="form-group">
                            <label for="distance" class="form-label">distance:</label>
                            <input type="text" id="distance" name="distance" class="form-control" value="{{ $routes->distance }}" required>
                        </div>
